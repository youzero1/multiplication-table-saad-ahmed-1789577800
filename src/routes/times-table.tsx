...
function TimesTablePage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center">
      <h1 className="text-center text-3xl font-bold tracking-tight text-yellow-50 sm:text-4xl">
        Multiplication Table of {MULTIPLIER}
      </h1>
      <p className="mt-3 mb-10 max-w-md text-center text-sm text-yellow-100/60 sm:text-base">
